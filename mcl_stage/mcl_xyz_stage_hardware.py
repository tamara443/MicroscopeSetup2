...
try:
    from mcl_nanodrive_interface import MCLNanoDrive
except Exception as err:
    print("Cannot load required modules for MclXYZStage:", err)
from qtpy import QtCore

import sys, os
mclStagePath = os.path.dirname(os.path.abspath(__file__))
sys.path.append(mclStagePath)

from mcl_nanodrive_interface import MCLNanoDrive

class MclXYZStageHW(HardwareComponent): #hardware
    ...
    def setup(self):
        ...
        self.MCL_AXIS_ID = dict(X = 1, Y = 2, Z = 3)
